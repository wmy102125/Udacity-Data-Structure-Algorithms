...
Start with a blank compoundList [[]]. This is actually the last call of recursive function 3_stacks_queues. Pick the element 2 of original input list, making the compoundList as [[2]]
